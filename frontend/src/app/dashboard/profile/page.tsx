...
export default function ProfileEditPage() {
  ...
  // Identity Verification States (Optional - Granting seal/badge)
  ...
  const handleVerifyDocument = (e: React.FormEvent) => {
    ...
    setOcrMessage('Enviando documento para análise...');

    setTimeout(() => {
      setVerifyingDoc(false);
      setOcrStatus('success');
      setOcrMessage('Seu documento foi enviado com sucesso! Após a revisão da administração (geralmente concluída em até 24 horas), você receberá o selo de verificação em seu perfil público.');
      setIsVerified(true);
    }, 2000);
  };
    ...
    <div className="flex-1 flex flex-col gap-xl">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-md">
        ...
        <div className="flex items-center gap-md">
          <Link href="/dashboard" className="text-on-surface-variant hover:text-on-surface text-label-md font-label-md px-md py-sm rounded-lg border border-outline hover:bg-surface-container-low transition-colors">
            Voltar ao Painel
          </Link>
          <button 
            type="button"
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        ...
        <div className="lg:col-span-2 flex flex-col gap-lg">
          ...
          {/* Card 4: Verificação de Identidade (Opcional) */}
          <section className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-lg shadow-sm flex flex-col gap-md">
            <div className="flex items-center justify-between border-b border-surface-variant pb-sm mb-xs">
              <h2 className="text-headline-md font-headline-md text-on-surface">Verificação de Identidade</h2>
              <span className="bg-amber-100 text-amber-800 text-[11px] font-bold px-2 py-0.5 rounded-full flex items-center gap-xs">
              ...
              <div className="flex items-start gap-md bg-emerald-50/50 border border-emerald-300 rounded-xl p-md text-emerald-950 text-body-sm">
                ...
                <div className="flex flex-col gap-2xs mt-2xs">
                  ...
                  <p className="text-body-xs text-emerald-800">
                    Sua identidade foi confirmada com sucesso. O selo de verificação está ativo no seu perfil e visível para todos os clientes.
                  </p>
                </div>
              </div>
            ) : (
              <div className="flex flex-col gap-md">
                <div className="flex items-start gap-sm bg-amber-50/40 border border-amber-200 p-md rounded-xl text-on-surface-variant text-body-sm">
                  <span className="material-symbols-outlined text-[24px] text-primary shrink-0">info</span>
                  <div className="flex flex-col gap-2xs">
                    <p className="text-body-xs font-semibold text-amber-900 leading-normal">
                      Aumente a confiança dos clientes em até 3x!
                    </p>
                    <p className="text-body-xs leading-normal">
                      Envie um documento oficial (RG, CPF ou CNH) para análise. Esta verificação é <strong>totalmente opcional</strong>, mas profissionais com documentos aprovados ganham um <strong>selo de verificação ouro</strong> em destaque nas buscas.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-end mt-2xs">
                  ...
                  >
                    {verifyingDoc ? 'Enviando...' : 'Enviar para Análise'}
                  </button>
                </div>
              </div>
            )}
                ...
                <div className="lg:col-span-4 flex flex-col gap-md">
                  <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-lg shadow-sm">
                    <div className="mb-md">
                      ...
                      <p className="text-body-xs text-on-surface-variant">Costuma responder em menos de 2 hours</p>
                    </div>
